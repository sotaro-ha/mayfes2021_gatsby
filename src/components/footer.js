    ...
    return (
        ...
        <div className={Styles.footer_nav}>
            ...
            <div className={Styles.footer_logo_box}>
                <p className={Styles.right} className={Styles.Logo}><a href="https://note.com/dp9" target="_blank"><StaticImage src="../images/general/note.svg"
                           /></a></p>
                <p className={Styles.right}><a href="https://twitter.com/DP9_Official?s=20" target="_blank"><StaticImage
                            src="../images/general/twitter.svg" /></a></p>
            </div>
        </div>
    </footer>
    )
