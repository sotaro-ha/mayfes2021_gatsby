    ...
    <div >
      ...
      >
        <div>
          ...
          <a href="https://drive.google.com/drive/folders/1hKy16rRNRliann12-q8PUXo3Mdm2V_tI?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
      <Modal 
...
※フチ無しカラー印刷を推奨します。</p>
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1u8C6wnDhXZ0bbNopgv9by959J4ieqflW?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
...
たまにはあえて、紙を濡らしてみるのも悪くない。 そんな思いから作った、”濡らすと読めるミステリー”です。 紙を濡らしてみるワクワク感と、結末に迫るワクワク感。 両方を味わっていただけたらなと思います。 ※A4普通紙に、インクジェット(家庭用)プリンターで印刷して下さい。レーザープリンター(コンビニなど)での印刷では、濡らしても読むことができないのでご注意下さい。 ※まず上の本文を読んでから、結末(下のモザイク部分)を濡らしてお読み下さい。水をたっぷり含ませたティッシュなどでなぞるとしっかり濡らせます。少し時間がかかりますが、乾くまで待つと読みやすくなります。 本文著者：山川方夫</p></div>
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1kRBfPISAoXYWDDdqAYZFbDAqQRR4xwzc?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
      ...
      >
       <div>
          ...
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1pX763Rm-UvfaZ2_Z5opbVMR_yh-6RVsC?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
...
......猫？ 一体何処に？ ここにあるのは餌皿だけだ。 夜中、猫がしきりに鳴いていたのを思い出す。 葉書の生々しい重みだけが、残っている。(この作品は葉書サイズ・フチなしプリントを推奨します)</p></div>
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1_7-Yz-SZhyYNdf1sYm0UwRCQZfyuubIf?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
      ...
      >
       <div>
          ...
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1iC4OQgutAD8402d2DLVtGW68LEJ5C3db?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          <a href=""><div className={Styles.driveButton}><FontAwesomeIcon icon={faVideo}/>　動画</div></a>
          </div>
        </div>
      </Modal>
      <Modal 
...
詩：春の詩集　河井酔茗「酔茗詩抄」より</p></div>
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1H_v7NWVZbN9MKg7OtBb75ry8bHieG18B?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
      ...
      >
        <div>
          ...
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1oWKo7lEP4HXEhkGxH_qrf3nBjdB4FlB8?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
      ...
      >
       <div>
          ...
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1zdTHIKLvz6aISAJPys0J9zj1tPE46GFO?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
      ...
      >
        <div>
          ...
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1MqJVX_1dSq4CG9_3fjGx-poi8sRp7Y6s?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
      ...
      >
        <div>
          ...
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/1E_7vCGyHOjumD6lkuPm4_G65iTXoTPZU?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
      ...
      >
        <div>
          ...
          <div className={Styles.buttonWrapper} >
          <a href="https://drive.google.com/drive/folders/12KXvY51iJvdeCSQUEkoiGKqwU4zliXfP?usp=sharing"><div className={Styles.driveButton}><FontAwesomeIcon icon={faGoogleDrive}/>　ダウンロード</div></a>
          <a href="https://twitter.com/share?url=https://dp9.tokyo/mayfes2021%20%23紙festa"><div className={Styles.driveButton}><FontAwesomeIcon icon={faTwitter}/>　シェア</div></a>
          </div>
        </div>
      </Modal>
